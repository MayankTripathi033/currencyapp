                ...
                >
                    <div className="w-full mb-1">
                        <InputBox
                            ...
                            onFromCurrencyChange={(currency)=> setFrom(currency)}
                            selectCurrency={from}
                    ...
                    <div className="relative w-full h-0.5">
                        <button
                            type="button"
                            className="absolute left-1/2 -translate-x-1/2 -translate-y-1/2 border-2 border-white rounded-md bg-blue-600 text-white px-5 py-3 text-xl"
                            onClick={swap}
                        >
                            swap
                        </button>
